...
public class StoryLoops2 : MonoBehaviour {
    ...
    IEnumerator scanner()
    {
        ...
        else if (scanCount == 4) { buttonCount = 8; }
        else if (scanCount == 5) { buttonCount = 10; }
        else if (scanCount == 6) { buttonCount = 11; }
        else if (scanCount == 7) { buttonCount = 13; }
    ...
    public void clearList()
    {
        ...
        stepCount = 0;
        shrinkCount = 0;
        help.text = "Show Dudley how to <b><color=yellow>Loop</color></b> by making Tommy <b><color=yellow>Jump</color></b> and <b><color=yellow>Spin</color></b>. \nIt's fun to do it over and over again.";
        playSound(2);
        movementLengthCollection = 0;
        movement.Clear();
